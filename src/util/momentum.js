// 这不是一个模拟，仅是对定时器方法的hack，在使用定时器方法之前引用
// see https://github.com/myonov/momentum
// Patches setInterval, clearInterval, setTimeout and clearTimeout 
// to avoid browser throttling these functions when tab is inactive.
(function() {
  var $momentum;
